...
// typedef for WormHeading enum
typedef enum WormHeading wHeading_t;

extern resCode_t initializeWorm(struct worm* aworm, int len_max, int len_cur,
                                    struct pos headpos, wHeading_t dir, colorPair_t color);
...
extern void moveWorm(struct board* aboard, struct worm* aworm, gameState_t *agame_state);
...
//Setters
extern void setWormHeading(struct worm* aworm, wHeading_t dir);
